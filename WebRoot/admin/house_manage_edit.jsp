			...
			<div class="row">
				<div class="col-xs-12">
					<ol class="breadcrumb">
						...
						<li><a href="/admin/house_manage.do">房屋管理</a></li>
						<c:choose>
							<c:when test="${type=='create'}">
							...
							<c:choose>
								<c:when test="${type == 'create' }">
									<form class="form-horizontal"
										action="/admin/editHouseSubmit.action?type=create"
										method="post">
								</c:when>
								<c:otherwise>
									<form class="form-horizontal"
										action="/admin/editHouseSubmit.action" method="post">
										<input type="hidden" name="id" value="${house.id}" />
										<div class="form-group">
											<label for="input1" class="col-xs-2 control-label">创建时间</label>
											<div class="col-xs-10">
												<input type="hidden" value="${house.createDate}"
													name="createDate" />
												<p class="form_control_p">
													<fmt:formatDate value='${house.createDate}'
														pattern='yyyy-MM-dd' />
												</p>
											</div>
										</div>
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input type="text" class="form-control" id="owner" name="owner"
										value='${house.owner}'> <input type="hidden"
										name="ownerId" value="${house.ownerId}" />
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<input type="text" class="form-control" id="input4"
										name="houseDetail" value='${house.houseDetail}'>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-xs-10 edit_select">
									<input type="text" class="form-control" id="regionName"
										value="${house.area}" readonly> <input type="hidden"
										id="regionId" name="regionId" value="${house.regionId}" /> <span
										class="glyphicon glyphicon-chevron-down edit_select_icon"></span>
							...
							<div class="form-group">
								...
								<div class="col-xs-10">
									<label class="checkbox-inline"><input type="radio"
										name="housetype" value="1"
										<c:if test="${house.houseType ==1 }">checked</c:if>>住房</label>
									<label class="checkbox-inline"><input type="radio"
										name="housetype" value="2"
										<c:if test="${house.houseType ==2 }">checked</c:if>>商铺</label>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-10">
									<label class="checkbox-inline"><input type="checkbox"
										value="床" name="facility"
										<c:if test="${fn:contains(house.facilities,'床')}">checked</c:if>>床</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="沙发" name="facility"
										<c:if test="${fn:contains(house.facilities,'沙发')}">checked</c:if>>沙发</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="桌子" name="facility"
										<c:if test="${fn:contains(house.facilities,'桌子')}">checked</c:if>>桌子</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="衣柜" name="facility"
										<c:if test="${fn:contains(house.facilities,'衣柜')}">checked</c:if>>衣柜</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="空调" name="facility"
										<c:if test="${fn:contains(house.facilities,'空调')}">checked</c:if>>空调</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="电视" name="facility"
										<c:if test="${fn:contains(house.facilities,'电视')}">checked</c:if>>电视</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="洗衣机" name="facility"
										<c:if test="${fn:contains(house.facilities,'洗衣机')}">checked</c:if>>洗衣机</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="热水器" name="facility"
										<c:if test="${fn:contains(house.facilities,'热水器床')}">checked</c:if>>热水器</label>
									<label class="checkbox-inline"><input type="checkbox"
										value="水、电、气" name="facility"
										<c:if test="${fn:contains(house.facilities,'水、电、气')}">checked</c:if>>水、电、气</label>
								</div>
							</div>
							<div class="form-group">
