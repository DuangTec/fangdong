...
<div class="login_regist container">
    <div class="login_regist_box">
        <h1>用户登录</h1>
        <form action="/userLogin.action" method="post" autocomplete="off">
            <ul>
                <li>
                    <input type="text" name="username_login" id="username_login" value="" placeholder="请输入用户名"
                           class="form-control"/>
                </li>
                <li>
                    <input type="password" name="password_login" id="password_login" value="" placeholder="请输入密码"
                           class="form-control"/>
                </li>
                <li>
